...
---
We have introduced placing single items within a flexbox and grid. Next up you will tackle containers\(parents\) with multiple items\(children\).
...
```
<!--TODO: THE ABOVE CODE IS INCORRECT/INCOMPLETE-->
...
![](/docs/0.1 flexbox_grids/FBassets/1.1_grid_container.PNG)
