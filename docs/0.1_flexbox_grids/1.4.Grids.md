...
With some minor adjustments the above CSS could be written as
...
.one {
grid-column: start / middle-end;
grid-row: start;
}
.two {
grid-column: middle-start / end;
grid-row: start / middle-end;
}
.three {
grid-column: start;
grid-row: middle-start / end;
}
.four {
grid-column: middle-start;
grid-row: middle-start;
}
.five {
grid-column: middle-start;
grid-row: middle-end;
